...
for n in range(0,len(max_temps)):
    if max_temps[n]>=current_max:
        current_max = max_temps[n]


current_min = min_temps[0]
for n in range(0,len(min_temps)):
    if min_temps[n]<=current_min:
        current_min = min_temps[n]
